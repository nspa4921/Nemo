...
export default function SimpleAccordion() {
  const classes = useStyles();
      return (
        <div className={classes.root}>
          <Container className="wrapper-right">  
            <Row xs="2">
                ...
                <CardTitle align="left" ><h2>WORKING EXPERIENCE</h2></CardTitle>
                    <hr/>
                    <br></br>
          <Accordion>
        <AccordionSummary
        ...
        <AccordionDetails>
          <Typography>
          <p align="justify">Conentrix offers customer support in the Nordic market, for both private and corporate customers. 
      ...
      <Accordion>
        ...
        >
          <Typography className={classes.heading}>   
                    <CardText align="left" >      
                    <h5><span className="fa fa-align-justify fa-lg"></span>MUNKEBJERG HOTEL</h5>    
                    <small>Maj 2014 – March 2016, Vejle, Danmark </small>
                    <p>Role: Facility assistant </p>
                    </CardText>
                    </Typography>
        </AccordionSummary>
        <AccordionDetails>
          <Typography>
          <p align="justify">In Munkebjerg hotel I worked for while I was studying the Danish language. My tasks were to help facilitating the hotel events. </p>
          </Typography>
        </AccordionDetails>
      </Accordion>
      ...
      <Accordion>
        ...
        >
          <Typography className={classes.heading}>   
                    <CardText align="left" >      
                    <h5><span className="fa fa-align-justify fa-lg"></span>TOURIS AGENCY "MOLNAR GABOR"</h5>
                    <small>Maj 2010 – Sept. 2012, Island Krk, Croatia  </small>
                    <p>Role: Front End web developer / Sales and marketing manager / Travel guide </p>
                    </CardText>
                    </Typography>
        </AccordionSummary>
        <AccordionDetails>
      ...
      <Accordion>
        ...
        >
          <Typography className={classes.heading}>   
                    <CardText align="left" >      
                    <h5><span className="fa fa-align-justify fa-lg"></span>HOSTEL "LAZIN HOSTEL” </h5>
                    <small>Sept. 2008 – Oct. 2009, Novi Sad, Serbia </small>
                    <p>Role: Web designer / Sales and marketing manager / Travel guide / Service assistant </p>
                    </CardText>
                    </Typography>
        </AccordionSummary>
        <AccordionDetails>
